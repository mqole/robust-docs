...
* [Git](https://git-scm.com/) or one of the [many](https://www.sourcetreeapp.com/) [third-party](http://www.syntevo.com/smartgit/) [UIs](https://tortoisegit.org/) that make it easier to use. Make sure to let it install to your PATH like [this](/img/setup/git-path.png).
* [Python 3.7 or higher](https://www.python.org/). Make sure to install it into your [PATH on Windows](/img/setup/python-path.png). Also make sure the 'py launcher' option is enabled when installing on Windows. You should get python from [python.org](https://www.python.org/). Versions installed from the windows store sometimes cause build issues.
...
:::warning[VScode/VsCodium and SLNX]
...
[![Space Station 14 Development Environment Setup](https://img.youtube.com/vi/EUGl_zNS6Uk/hqdefault.jpg)](https://www.youtube.com/watch?v=EUGl_zNS6Uk)

You may also always ask for help in the official [Wizard's Den discord](https://discord.spacestation14.io).

## 1. Cloning

:::danger[Do not download as a zip from GitHub]
...
![](/img/general-development/setup/setting-up-a-development-environment/vs-solution-explorer-switch-view-1.png)
![](/img/general-development/setup/setting-up-a-development-environment/vs-solution-explorer-switch-view-2.png)
...
![](/img/general-development/setup/setting-up-a-development-environment/vs-solution-explorer-switch-view-3.png)
