...
![markup-example.png](/img/general-development/tips/writing-guidebook-entries/tips-markup-example.png)
...
![guidebook-table-example.png](/img/general-development/tips/writing-guidebook-entries/guidebook-table-example.png)
...
You can learn more about localization [here](../../guides/misc/fluent-and-localization.md).
