...
![](/img/general-development/tips/debugging-tools/debug-gcserver.png)
...
![many-run-configurations.png](/img/general-development/tips/debugging-tools/debug-run-configs.png)
...
![rider_debugger_opts.png](/img/general-development/tips/debugging-tools/debug-rider-opts.png)
