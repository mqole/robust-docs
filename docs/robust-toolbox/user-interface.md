...
![escape-menu-ui.png](/img/robust-toolbox/user-interface/escape-menu-ui.png)
...
![escape-menu-button-rect-example.png](/img/robust-toolbox/user-interface/escape-menu-button-rect-example.png)
...
![escape-menu-button-rect-example-2.png](/img/robust-toolbox/user-interface/escape-menu-button-rect-example-2.png)
...
![escape-menu-shrink-example.png](/img/robust-toolbox/user-interface/escape-menu-center-example.png)
...
![escape-menu-left-example.png](/img/robust-toolbox/user-interface/escape-menu-left-example.png)
...
![escape-menu-box-left-example.png](/img/robust-toolbox/user-interface/escape-menu-box-left-example.png)
...
![escape-menu-expand-example-1.png](/img/robust-toolbox/user-interface/escape-menu-expand-example-1.png)
...
![escape-menu-expand-example-2.png](/img/robust-toolbox/user-interface/escape-menu-expand-example-2.png)
...
![escape-menu-expand-example-3.png](/img/robust-toolbox/user-interface/escape-menu-expand-example-3.png)
...
If you are experienced with HTML, in XML any tag can be either open or closed. Also XML does not allow the various parser edge cases based on tag name (``, ``, ...), it's much more consistent.
