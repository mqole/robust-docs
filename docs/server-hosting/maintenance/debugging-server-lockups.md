...
![scsi prompt about to run 'while (true) { }'](/img/server-hosting/scsi-while-true.png)
...
![Showing the navigation in WinDBG to open dump file](/img/server-hosting/windbg-open.png)
