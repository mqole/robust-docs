...
![log-in-with-ss14.png](/img/server-hosting/hosting-log-in-with-ss14.png)
...
![Space Station 14 auth error screen just saying "An error occurred while processing your request."](/img/server-hosting/oauth-error.png)
...
![Browser dev tools showing login requests, with the redirect URI being underlined in one of them](/img/server-hosting/oauth-redirect-uri-devtools.png)
