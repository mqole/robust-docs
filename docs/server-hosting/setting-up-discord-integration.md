...
5. Go to "OAuth" and generate an installation URL by ticking the following checkboxes and pressing copy: ![Discord's OAuth2 URL generator, with "bot" scopes and "Send Messages" bot permissions checked](/img/server-hosting/setting-up-discord-integration/embedded-discord-bot-perms.png)
...
![Screenshot of Overseer's Discord profile](/img/server-hosting/setting-up-discord-integration/overseer.png)
...
#### Game server status
![SS14 Status](/img/server-hosting/setting-up-discord-integration/SS14-game-status-example.png)
...
![SS14 Status Watches](/img/server-hosting/setting-up-discord-integration/SS14-game-status-watches.png)
...
![Poweractions](/img/server-hosting/setting-up-discord-integration/poweractions-example.png)
...
![Input field](/img/server-hosting/setting-up-discord-integration/redbot-poweactions-form.png)
...
![why](/img/server-hosting/setting-up-discord-integration/autoresponder-example.png)
