...
:::info[Important Notes for basically everything here]
...
![router-address-bar.png](/img/server-hosting/port-forwarding/router-address-bar.png)

In the best case scenario, you now have some sort of login screen open:

![router-login.png](/img/server-hosting/port-forwarding/router-login.png)
...
![router-forward-add.png](/img/server-hosting/port-forwarding/router-forward-add.png)
...
:::danger[Playit.gg is not gurunteed to be free anymore. And localtonet kinda sucks.]
