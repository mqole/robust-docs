...
![](/img/robust-toolbox/rendering/vsm-blue-bleed.png)
...
![](/img/robust-toolbox/rendering/after-apply-lighting.png)

Lighting framebuffer after applying FOV (center of window).

![](/img/robust-toolbox/rendering/after-apply-fov.png)
...
![](/img/robust-toolbox/rendering/wall-bleed.png)
...
![](/img/robust-toolbox/rendering/low-wall-corners.png)
